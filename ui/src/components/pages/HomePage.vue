<template>
  <div class="nh-home-page flex flex-col flex-nowrap items-center px-6 lg:px-8">
    <div class="mx-auto max-w-[100%] text-center lg:max-w-4xl">
      ...
      <h4 class="text-nh-bali-hai-800 pb-4 pt-2 text-2xl tracking-light text-left">
        Current User:
      </h4>
      ...
      <pre
        class="border-nh-bali-hai-300 bg-nh-bali-hai-200 text-nh-bali-hai-900 max-h-[800px] overflow-x-scroll rounded-md p-2 text-left text-lg leading-8 shadow-inner whitespace-pre"
