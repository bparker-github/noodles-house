...
import BlurCanvas, { type BlurCanvasProps } from './BlurCanvas.vue';
import { parseAsInt, percentAsRatio } from './tools';
...
export default class BlurHash extends Vue {
  ...
  get cssVars() {
    return {
      '--transition-duration':
        this.transitionDuration > 0 ? `${this.transitionDuration / 1000}s` : 'none',
    };
  }
}
</script>
