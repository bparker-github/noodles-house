import type { RequireOnlyOne } from "../types/augments";
...
export class EnumObject<Val extends IEnumObjectValue = string>
  implements IEnumObject<Val>
{
  constructor(
    public label: string,
    public value: Val
...
export type IAsyncEnumObject<T extends IEnumObjectValue = string> =
  RequireOnlyOne<
    RequireOnlyOne<_IAsyncEnumObject<T>, "innerLabel" | "labelGetter">,
    "innerValue" | "valueGetter"
  >;

export class AsyncEnumObject<Val extends IEnumObjectValue = string>
  implements IEnumObject<Val>
{
