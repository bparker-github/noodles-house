      ...
      >
        <DisclosureButton
          ...
          :class="[
            ...
            'text-whiteish group flex gap-x-3 rounded-md py-2 px-3 text-base font-medium shadow-md shadow-nh-mallard-600',
            !item.current
              ? 'hover:bg-nh-mallard-700 hover:text-white'
              : 'bg-nh-mallard-800 hover:bg-nh-mallard-600',
          ]"
